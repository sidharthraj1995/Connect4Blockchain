...
msg = "Would you like to play with AI or Human?"
choices = ["AI","Human"]
...
def winning_text():
    if turn % 2 == 0:
        ...
        label = win_text.render("{} wins!".format(winning_player), 1, YELLOW)
    else:
...
pygame.display.set_caption('Connect 4 with Komodo Blockchain')
                ...
                if turn % 2 == 0:
                    ...
                    if is_valid_location(board, col):
                        ...
                        if winning_move(board, PLAYER_1_PIECE):
                            label = win_text.render("Red won!", 1, YELLOW)
                            print("Red won")
                            screen.blit(label, (40, 10))
                            game_over = True
                ...
                if turn % 2 != 0:
                    ...
                    if is_valid_location(board, col):
                        ...
                        if winning_move(board, PLAYER_2_PIECE):
                            label = win_text.render("Yellow won!", 1, YELLOW)
                            print("Yellow won")
                            screen.blit(label, (40, 10))
                            game_over = True
